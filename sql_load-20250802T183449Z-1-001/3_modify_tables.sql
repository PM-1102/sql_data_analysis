...
COPY company_dim
FROM 'H:\sql_data_analysis\csv_files-20250802T184122Z-1-001\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'H:\sql_data_analysis\csv_files-20250802T184122Z-1-001\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'H:\sql_data_analysis\csv_files-20250802T184122Z-1-001\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'H:\sql_data_analysis\csv_files-20250802T184122Z-1-001\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
